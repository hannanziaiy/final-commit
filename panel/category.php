...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['submit'])) {
    if (empty($_POST['category'])) {
      $error_message = "نام دسته بندی را وارد کنید.";
    } else {

      ///////////////////////
      $categoryName = $_POST['category'];
      $categoryNameSlug = generateSeoURL($categoryName);
      $qqq = "def";
      $category = array(
        "name" => $categoryName,
      ...
      $record = new ActiveRecord($conn, $tbname, $dbname, null, $category);
      $record->save();
    }
  }
}
...
<body>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">پنل مدیریت</a>
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="comments">
                  <svg class="bi">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="myChart" width="" height="">
          <form method="POST">
            <div class="mb-3">
              <label for="category" class="form-label">نام دسته بندی</label>
              <input type="text" class="form-control" id="category" name="category" required placeholder=" مثال : هوا شناسی">
              <br />
        ...
        <div class="table-responsive small">
          ...
          <?php
          $stmt = $conn->prepare("SELECT id, name, slug FROM $dbname.$tbname");
          $stmt->execute();
